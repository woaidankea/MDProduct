...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        headImageBackView.backgroundColor = [[UIColor clearColor] colorWithAlphaComponent:0.4];
        [self.contentView addSubview:headImageBackView];
        self.btnHeadImage = [UIButton buttonWithType:UIButtonTypeCustom];
        self.btnHeadImage.layer.cornerRadius = 15;
...
- (void)setMessageFrame:(UUMessageFrame *)messageFrame{
    ...
    if (message.from == UUMessageFromMe) {
        ...
        normal = [normal resizableImageWithCapInsets:UIEdgeInsetsMake(40,20, 20, 20) resizingMode:UIImageResizingModeStretch];
    }
    else{
