...
- (id)initWithSuperVC:(UIViewController *)superVC
{
    ...
    if (self) {
        ...
        self.btnSendMessage.frame = CGRectMake(7.5, 7.5, 25, 25);
...
//        [self addSubview:self.btnVoiceRecord];
        ...
        //输入框
        self.TextViewInput = [[UITextView alloc]initWithFrame:CGRectMake(45, 5, Main_Screen_Width-52.5, 30)];
...
-(void)addCarema{
    if ([UIImagePickerController isSourceTypeAvailable:UIImagePickerControllerSourceTypeCamera]) {
        ...
        //如果没有提示用户
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"提示" message:@"您未开启相机权限" delegate:nil cancelButtonTitle:@"Sure" otherButtonTitles:nil];
        [alert show];
    }
}
