...
- (instancetype) initWithFrame:(CGRect)frame {
    return [self initWithFrame: frame type: AdLaunchProgressType andUrl:_imageURL];
}

- (instancetype) initWithFrame: (CGRect)frame type: (AdLaunchType) type andUrl:(NSString *)url {
    state = type;
    _imageURL = url;
