...
@interface MDDeliciousViewController ()<ArticleCellDelegate>

@end

@implementation MDDeliciousViewController
...
- (void)tableViewHeaderRefresh{
    ...
    [self HTTPLocationRequest:MD_Delicious];
}
