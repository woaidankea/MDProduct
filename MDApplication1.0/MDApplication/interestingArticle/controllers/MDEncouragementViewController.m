//
//  MDEncouragementViewController.m
//  MDApplication
//
...
@interface MDEncouragementViewController ()<ArticleCellDelegate>

@end

@implementation MDEncouragementViewController
...
- (void)tableViewHeaderRefresh{
    ...
    [self HTTPLocationRequest:MD_Encourage];
}
