...
@interface MDFashionViewController ()<ArticleCellDelegate>

@end

@implementation MDFashionViewController
...
- (void)tableViewHeaderRefresh{
    ...
    [self HTTPLocationRequest:MD_Fashion];
}
