...
@interface MDMotherChildViewController ()<ArticleCellDelegate>

@end

@implementation MDMotherChildViewController
...
- (void)tableViewHeaderRefresh{
    ...
    [self HTTPLocationRequest:MD_Mother];
}
