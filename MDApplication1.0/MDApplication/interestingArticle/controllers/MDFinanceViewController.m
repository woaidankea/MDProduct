...
@interface MDFinanceViewController ()<ArticleCellDelegate>

@end

@implementation MDFinanceViewController
...
- (void)tableViewHeaderRefresh{
    ...
    [self HTTPLocationRequest:MD_Finance];
}
