//
//  MDEncyclopediasViewController.m
//  MDApplication
//
...
@interface MDEncyclopediasViewController ()<ArticleCellDelegate>

@end

@implementation MDEncyclopediasViewController
...
- (void)tableViewHeaderRefresh{
    ...
    [self HTTPLocationRequest:MD_Encyclopedias];
}
