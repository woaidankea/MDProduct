//
//  MDEntertainmentViewController.m
//  MDApplication
//
...
@interface MDEntertainmentViewController ()<ArticleCellDelegate>

@end

@implementation MDEntertainmentViewController
...
- (void)tableViewHeaderRefresh{
    ...
    [self HTTPLocationRequest:MD_Entertainment];
}
