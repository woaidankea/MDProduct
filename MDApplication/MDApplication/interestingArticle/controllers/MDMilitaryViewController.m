...
@interface MDMilitaryViewController ()<ArticleCellDelegate>

@end

@implementation MDMilitaryViewController
...
- (void)tableViewHeaderRefresh{
    ...
    [self HTTPLocationRequest:MD_Military];
}
