...
@interface MDTechnologyViewController ()<ArticleCellDelegate>

@end

@implementation MDTechnologyViewController
...
- (void)tableViewHeaderRefresh{
    ...
    [self HTTPLocationRequest:MD_Technology];
}
